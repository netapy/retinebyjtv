...
let templateUserProj = '<div class="col-12 col-sm-6 col-lg-4 mb-5"><div class="projetTile neuProjet d-flex align-items-center justify-content-stretch flex-column hvr-float" onclick="##FUNCTION##"><div class="threeDot hvr-bounce-in" onclick="##FUNCTIONSHARE##;window.event.stopPropagation();"><img class="w-100" src="/img/icons/##ICON##"></div><div class="p-3 pr-5 w-100 h-75 m-0" style="background-color: ##PROJCOLOR##; border-radius:  10px  10px 0px 0px; color: white;"><div><h3>##NOMPROJ##</h3></div></div><div class="px-3 flex-fill d-flex justify-content-between align-items-center w-100"><div class="d-fk">##CREADATE##</div><div>##NBREP##</div></div></div></div>';
